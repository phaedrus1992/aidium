...
- (void)installPlugin
{
	...
	NSToolbarItem *chatItem =
		[AIToolbarUtilities toolbarItemWithIdentifier:TOOLBAR_NOTIFY_IDENTIFIER
												label:NOTIFICATION
									...
									includeSubject:(BOOL)includeSubject
{
	...
	if (includeSubject) {
		...
		description = AILocalizedString(@"wants your attention!",
										"Phrase displayed when a contact sends a buzz/nudge/other notification. The "
										"contact's name will be shown above this phrase, as in a Growl notification.");
	}

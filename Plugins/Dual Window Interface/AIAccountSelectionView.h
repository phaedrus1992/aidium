 ...
 *
 *	@par	This view contains two pop-up menus: One for accounts, and the other for contacts. It appears at the top of
 * the chat window when the user double-clicks on a contact row in the contact list, and when the chat receives content
 * from a different contact in the same metacontact as the existing current contact.
 */

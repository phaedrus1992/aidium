...
typedef enum { AISwitchArrows = 0, AISwitchShiftArrows, AIBrackets, AIBraces, AIOptArrows, AICtrlTab } AITabKeys;

typedef enum { AISendOnEnter = 0, AISendOnReturn, AISendOnBoth } AISendKeys;

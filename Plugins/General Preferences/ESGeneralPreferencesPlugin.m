...
{
	// Defaults
	[adium.preferenceController registerDefaults:[NSDictionary dictionaryNamed:TAB_DEFAULT_PREFS forClass:[self class]]
...
- (void)hitHotKey:(AIHotKey *)hotKey
{
	...
	// Switch to the appropriate window, just like clicking the dock; this method will handle switching to a chat with
	// unviewed content, for example.

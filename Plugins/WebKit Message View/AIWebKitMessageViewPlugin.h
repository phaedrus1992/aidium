...
typedef enum { AIWebkitRegularChat = 0, AIWebkitGroupChat } AIWebkitStyleType;
...
/*!
 *	This method is fairly expensive the first time it's run; however, the first time will almost always been in a thread
 * at startup, to preload the styles. This method is threadsafe.

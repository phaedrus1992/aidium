    ...
    decisionListener:(id<WebPolicyDecisionListener>)listener
{
    ...
    if (actionKey == WebNavigationTypeOther) {
		[listener use];
	} else if ([[[((NSString *)LSCopyDefaultHandlerForURLScheme((CFStringRef)request.URL.scheme)) autorelease] lowercaseString] isEqualToString:@"com.github.phaedrus1992.adiumy.adiumx"]) {

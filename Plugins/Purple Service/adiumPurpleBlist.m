...
static void adiumPurpleBlistRemove(PurpleBuddyList *list, PurpleBlistNode *node)
{
	@autoreleasepool {
		...
		if (PURPLE_BLIST_NODE_IS_BUDDY(node)) {
			...
			// Clear the ui_data
			(void)(__bridge_transfer id)buddy->node.ui_data;
...
static PurpleBlistUiOps adiumPurpleBlistOps = {adiumPurpleBlistNewList,        adiumPurpleBlistNewNode,
											   adiumPurpleBlistShow,           NULL,
											   adiumPurpleBlistRemove,         adiumPurpleBlistDestroy,
											   adiumPurpleBlistSetVisible,     adiumPurpleBlistRequestAddBuddy,
											   adiumPurpleBlistRequestAddChat, adiumPurpleBlistRequestAddGroup,
											   /* save_node */ NULL,
											   /* remove_node */ NULL,
											   /* save_account */ NULL,

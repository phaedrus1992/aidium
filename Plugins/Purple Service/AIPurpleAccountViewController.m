...
- (void)configureViewAfterLoad
{
	...
	[textField_accountName
		setFormatter:[AIStringFormatter
						 stringFormatterAllowingCharacters:
							 [NSCharacterSet
								 characterSetWithCharactersInString:@"abcdefghijklmnopqrstuvwxyz0123456789@. "]
													length:24
											 caseSensitive:NO
											  errorMessage:@"Your user name must be 24 characters or less, contain "
														   @"only letters and numbers, and start with a letter."]];

...
static PurpleXferUiOps adiumPurpleFileTransferOps = {adiumPurpleNewXfer,       adiumPurpleDestroy,
													 adiumPurpleAddXfer,       adiumPurpleUpdateProgress,
													 adiumPurpleCancelLocal,   adiumPurpleCancelRemote,

...
static PurpleDebugUiOps adiumPurpleDebugOps = {adiumPurpleDebugPrint, adiumPurpleDebugIsEnabled,
...
static void adiumPurpleCoreUiInit(void)
{
	@autoreleasepool {
		...
		NSString *preferredLocale =
			[[[NSBundle bundleForClass:[SLPurpleCocoaAdapter class]] preferredLocalizations] objectAtIndex:0];
...
static GHashTable *adiumPurpleCoreGetUiInfo(void)
{
	@autoreleasepool {
		...
		if (!ui_info) {
			...
			/* prpl-aim-clientkey is a DevID (or "client key") for Adium, given to us by an AOL representative in March
			 * 2017.
			 */
...
static PurpleCoreUiOps adiumPurpleCoreOps = {adiumPurplePrefsInit, adiumPurpleCoreDebugInit, adiumPurpleCoreUiInit,
											 adiumPurpleCoreQuit, adiumPurpleCoreGetUiInfo,

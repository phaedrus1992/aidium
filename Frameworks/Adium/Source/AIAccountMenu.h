...
typedef enum { AIAccountNoSubmenu = 0, AIAccountStatusSubmenu, AIAccountOptionsSubmenu } AIAccountSubmenuType;
 ...
 *
 *	@par	By default, menu items in the account menu use the menu font, but a client can request them with the system
 * font instead.
 */

 ...
 *
 * If the menu item isn't the first in its menu, it can be connected to the Quit Adium menu item; AIMenuController will
 * move it to the appropriate place.
 */
typedef enum {
	LOC_Adium_About = 0,
	LOC_Adium_Preferences,
	LOC_Adium_Other,
	LOC_File_New,
	LOC_File_Close,
	LOC_File_Save,
	...
	LOC_View_Sorting,
	LOC_View_Toggles,
	LOC_View_Counting_Toggles,
	LOC_View_Appearance_Toggles,
	LOC_View_Additions,
	LOC_Display_General,
	LOC_Display_Jump,
	LOC_Display_MessageControl,
	LOC_Contact_Manage,
	LOC_Contact_Info,
	LOC_Contact_Action,
	LOC_Contact_NegativeAction,
	LOC_Contact_Additions,
	LOC_Status_State,
	LOC_Status_SocialNetworking,
	LOC_Status_Accounts,
	LOC_Status_Additions,
	LOC_Format_Styles,
	LOC_Format_Palettes,
	LOC_Format_Additions,
	LOC_Window_Top,
	LOC_Window_Commands,
	LOC_Window_Auxiliary,
	LOC_Window_Fixed,
	LOC_Help_Local,
	LOC_Help_Web,
	LOC_Help_Additions,
...
typedef enum {
	Context_Group_AttachDetach,
	Context_Contact_AttachDetach,
	Context_Group_Manage,
	Context_Contact_Manage,
	Context_Contact_Action,
	Context_Contact_NegativeAction,
	Context_Contact_Message,
	Context_Contact_Additions,
	Context_Contact_ChatAction,
	Context_Contact_Stranger_ChatAction,
	Context_Contact_ListAction,
	Context_Contact_GroupChat_ParticipantAction,
	Context_GroupChat_Manage,
	Context_GroupChat_Action,
	Context_Tab_Action,
	Context_TextView_LinkEditing,

...
typedef enum { AIQuitConfirmAlways = 0, AIQuitConfirmSelective } AIQuitConfirmationType;

typedef enum { AIMessageCloseAlways = 0, AIMessageCloseUnread } AIMessageCloseConfirmationType;

@protocol AIAccountController
, AIChatController, AIContactAlertsController, AIDebugController, AIEmoticonController, AIPreferenceController,
	AIMenuController, AIApplescriptabilityController, AIStatusController, AIContentController, AIToolbarController,
	AISoundController, AIDockController, AIFileTransferController, AILoginController, AIInterfaceController,
	AIContactController;
 ...
 * Use a list object observer (see AIContactController) if you are concerned about specific account connectivity
 * changes.
 */

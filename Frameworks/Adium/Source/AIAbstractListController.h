...
@class AIAutoScrollView, AIContactList, AIListOutlineView, AIListContactCell, AIListGroupCell, ESObjectWithProperties,
	AIListObject, AIListContact, AIChat;
...
typedef enum { STATUS_ONLY = 0, IDLE_ONLY, IDLE_AND_STATUS } EXTENDED_STATUS_STYLE;
...
@interface AIAbstractListController
	: NSObject <AISmoothTooltipTrackerDelegate, NSOutlineViewDelegate, NSOutlineViewDataSource> {

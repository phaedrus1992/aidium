...
- (NSString *)internalUniqueObjectID;
+ (NSString *)internalUniqueObjectIDForService:(AIService *)inService
									   account:(AIAccount *)inAccount
										   UID:(NSString *)inUID;
- (void)restoreGrouping;

@property(readonly, nonatomic)
	AIListContact *parentContact; // This needs renaming. It's the 'topmost' contact, either self or meta
...
@property(readonly, nonatomic)
	BOOL existsServerside; // Metas and Bookmarks (among others?) have no serverside representation
...
- (void)setServersideAlias:(NSString *)alias silently:(BOOL)silent;

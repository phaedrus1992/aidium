...
- (void)drawInteriorWithFrame:(NSRect)cellFrame inView:(NSView *)controlView
{
	...
	BOOL highlighted = ([self isHighlighted] && [[controlView window] firstResponder] == controlView &&
	...
	if (title != nil) {
		...
		//
		if (font) {
			attributes = [NSDictionary dictionaryWithObjectsAndKeys:font, NSFontAttributeName, style,
																	NSParagraphStyleAttributeName, textColor,
																	NSForegroundColorAttributeName, nil];
		} else {
			attributes = [NSDictionary dictionaryWithObjectsAndKeys:style, NSParagraphStyleAttributeName, textColor,
																	NSForegroundColorAttributeName, nil];
		}

 ...
 *
 * The image will be increasingly compressed until it fits within maxByteSize. The dimensions of the image are
 * unchanged, so for best quality results, the image should be sized (via -[NSImage(AIImageDrawingAdditions)
 * imageByScalingToSize:]) before calling this method.
 *

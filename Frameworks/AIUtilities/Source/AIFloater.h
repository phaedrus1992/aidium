 ...
 * @param animate If YES and inVisibile is the opposite of the current visibility, the image will fade into/out of view
 * by changing its opacity over time towards its maximum (to fade in) or towards 0 (to fade out).
 */
 ...
 *
 * The floater will never exceed this opacity; it will be shown at it when visible and will fade to/from it if animating
 * into/out of view.
 *

 ...
 *
 * An NSWindow subclass which docks to screen edges. It also posts AIWindowToolbarDidToggleVisibility to the default
 * notification center when its toolbar visibility is toggled with an object of the window.
 *

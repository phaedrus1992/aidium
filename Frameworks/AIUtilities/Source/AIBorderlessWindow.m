 ...
 */
// AIBorderlessWindow.m based partially off sample code in CustomWindow.m from Apple's "RoundTransparentWindow" sample
// project.
...
- (void)mouseDragged:(NSEvent *)theEvent
{
	if (![theEvent cmdKey] && moveable) {
		...
		// If the user is not pressing shift, attempt to dock this window the the visible frame first, and then to the
		// screen frame

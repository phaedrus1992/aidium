 ...
 *
 * An <tt>NSImageCell</tt> subclass which scales its image to fit.  The image will be scaled proportionally if needed,
 * modifying the size in the optimal direction.
 */

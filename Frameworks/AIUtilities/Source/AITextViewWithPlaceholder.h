 ...
 *
 * <tt>NSTextView</tt> sublcass which supports placeholders, text which is displayed but greyed out when the text view
 * is empty and unselected, even on 10.2; this is a feature which was added in 10.3.
 */
 ...
 *
 * Set the placeholder string, which is text which is displayed but greyed out when the text view is empty and
 * unselected.

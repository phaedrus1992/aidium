 ...
 *
 * <tt>NSFormatter</tt> subclass which formats to a specified <tt>NSCharacterSet</tt> and length.  An errorMessage may
 * be set which will be displayed after the user makes 3 invalid input attempts.
 */
 ...
 * @param errorMessage A message to be displayed to the user after 3 invalid input attempts. If nil, no error message is
 * displayed.

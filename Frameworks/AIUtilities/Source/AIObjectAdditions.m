...
- (id)mainPerformSelector:(SEL)aSelector returnValue:(BOOL)flag
{
	...
	if (flag) {
		...
		[self performSelectorOnMainThread:@selector(handleInvocation:) withObject:invocation waitUntilDone:YES];
...
{
	[self mainPerformSelector:aSelector
...
- (void)mainPerformSelector:(SEL)aSelector
				 ...
				 withObject:(id)argument2
				 withObject:(id)argument3
				 withObject:(id)argument4
{
	[self mainPerformSelector:aSelector
				   withObject:argument1
				   withObject:argument2
				   withObject:argument3
				   withObject:argument4
				waitUntilDone:NO];
}
- (void)mainPerformSelector:(SEL)aSelector
				 withObject:(id)argument1

 ...
 *
 * This will be posted to the default NSNotificationCenter before the system goes to sleep. To suspend the sleep
 * process, see <tt>AISystemHoldSleep_Notification</tt>.
 */
 ...
 *
 * This should be posted to the default NSNotificationCenter to request that the sleep process be suspended.  It should
 * be paired with <tt>AISystemContinueSleep_Notification</tt> to allow the sleep process to resume.
 */
 ...
 *
 * This should be posted to the default NSNotificationCenter to allow the sleep process to continue.  It is paired with
 * <tt>AISystemHoldSleep_Notification</tt>.
 */

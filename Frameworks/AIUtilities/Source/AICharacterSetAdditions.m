 ...
 *
 * NSMutableCharacterSet's documentation states that immutable NSCharacterSets are more efficient than
 * NSMutableCharacterSets. Shark sampling demonstrates this to be true as of OS X 10.4.5.
 *

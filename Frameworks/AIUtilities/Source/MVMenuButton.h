 ...
 *
 * Button which has a popup menu, including a menu arrow in the bottom right corner, for use as the custom view of an
 * NSToolbarItem
 */
 ...
 *
 * The arrow is black and positioned in the lower righthand corner of the button; it is used to indicate that clicking
 * on the button will reveal further information or choices.

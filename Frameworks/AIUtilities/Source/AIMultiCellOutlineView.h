 ...
 *
 * This outline view is a subclass of <tt>AIAlternatingRowOutlineView</tt> which simplifies its implementation into the
 * case with two different cells, one for expandable items ("groups") and one for nonexpandable items ("content").
 */

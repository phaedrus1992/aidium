...
typedef enum { AIPasswordPromptOKReturn = 0, AIPasswordPromptCancelReturn } AIPasswordPromptReturn;
 ...
 * @param inSelector Selector on target. Signature is - (void)passwordReturnedForConnect:(NSString *)inPassword
 * returnCode:(AIPasswordPromptReturn)returnCode context:(id)inContext

...
- (NSDictionary *)dictionaryRepresentation
{
	...
	return [NSDictionary
		dictionaryWithObjectsAndKeys:[NSNumber numberWithUnsignedInteger:self.keyCode], AIHotKeyKeyCodeKey,
									 [NSNumber numberWithUnsignedInteger:carbonFlags], AIHotKeyModifiersKey, nil];
}

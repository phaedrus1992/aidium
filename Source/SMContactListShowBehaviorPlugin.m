			   ...
			   userInfo:(id)userInfo
{
	...
	AISCLViewPlugin *contactListViewPlugin =
		(AISCLViewPlugin *)[[adium componentLoader] pluginWithClassName:@"AISCLViewPlugin"];
	...
	[self performSelector:@selector(hideContactList:) withObject:nil afterDelay:secondsToShow];

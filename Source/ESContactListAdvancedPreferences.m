...
- (void)viewDidLoad
{
	...
	menuIndex = [popUp_windowPosition
		indexOfItemWithTag:[[adium.preferenceController preferenceForKey:KEY_CL_WINDOW_LEVEL
...
#define WHILE_ADIUM_IS_IN_BACKGROUND                                                                                   \
	...
	[[matrix_hiding cellWithTag:AIContactListWindowHidingStyleSliding]
		setTitle:AILocalizedString(@"On screen edges",
	...
	[checkBox_animateChanges
		setLocalizedString:AILocalizedString(
							   @"Animate changes",
							   "This string is under the heading 'Contact List' and refers to changes such as sort "
							   "order in the contact list being animated rather than occurring instantenously")];

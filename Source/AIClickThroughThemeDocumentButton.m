...
/*!
 * @brief HACK: When deallocing, we crash in setRepresentedFilename presumably because of an NSCoder failure in
 * AIMesageWindow
 */
 ...
 *
 * If we do, we'll crash, since there shouldn't actually *be* a theem document button with no represented filename and
 * no document.
 */
- (void)showPopup
{

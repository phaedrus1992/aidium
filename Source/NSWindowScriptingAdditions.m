...
/**
 * @brief Produces a script error, as the title is not (and should not be) settable.
 */
- (void)setScriptingTitle:(NSString *)title
{
	[[NSScriptCommand currentCommand] setScriptErrorNumber:errOSACantAssign];
	[[NSScriptCommand currentCommand] setScriptErrorString:@"Can't set window title."];
}
@end

...
/*!
 * @name add
 * @brief User pressed ok on sheet - Calls createBookmarkWithInfo: on the delegate class AIBookmarkController, which
 * creates a new bookmark with the entered name & moves it to the entered group.
 */
...
- (void)buildGroupMenu
{
	...
	if ([menu numberOfItems] == 0) {
		[menu addItemWithTitle:DEFAULT_GROUP_NAME target:nil action:nil keyEquivalent:@""];
	}

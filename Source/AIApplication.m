 ...
 * In actuality, this returns the most recently active chat, which will return a chat even if all chat windows are
 * closed. For some reason [AIInterfaceController activeChat] doesn't work like I would have expected it to.
 */
- (AIChat *)activeChat
{

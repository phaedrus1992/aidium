...
- (NSDictionary *)restorablePreferences
{
	...
	NSDictionary *defaultsTemp = [NSDictionary
		dictionaryWithObjectsAndKeys:[defaultPrefs objectForKey:KEY_SCL_BORDERLESS], KEY_SCL_BORDERLESS,
									 ...
									 [defaultPrefs objectForKey:KEY_SCL_OUTLINE_GROUPS_COLOR],
									 KEY_SCL_OUTLINE_GROUPS_COLOR, [defaultPrefs objectForKey:KEY_SCL_SHOW_TOOLTIPS],
									 KEY_SCL_SHOW_TOOLTIPS, nil];
...
- (void)viewDidLoad
{
	...
	[colorWell_outlineGroupsColor
		setColor:[[preferenceDict objectForKey:KEY_SCL_OUTLINE_GROUPS_COLOR] representedColor]];
...
- (void)viewWillClose
{
	if ([colorWell_outlineGroupsColor isActive])

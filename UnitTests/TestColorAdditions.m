...
#define TEST_STRING_4                                                                                                  \
	@"Great fort this is powerful numberted, but and thuse everyone has no way to a closedish, Russiate it!"
#define TEST_STRING_5 @"You capacith this by having testing: there's sting AV coming from other Skype?"
#define TEST_STRING_6                                                                                                  \
	@"To can rience lawyers involvement in the most from the publicant progres is not running and tell you what we "   \
	@"did pas alway or may not be submits IP. If the IP hunt down bugs will beta iterat yet."
...
- (void)testDarkenRed
{
	...
	STAssertEquals([redDarkened greenComponent], [red greenComponent],
				   @"Darkening red by 0.5 should not change its green");
	STAssertEquals([redDarkened blueComponent], [red blueComponent],
				   @"Darkening red by 0.5 should not change its blue");
}
...
- (void)testDarkenAndSaturateRed
{
	...
	NSColor *redDarkened = [red darkenBy:0.5f];
	STAssertEquals([redDarkened redComponent], (CGFloat)0.5f,
				   @"Darkening and saturating red by 0.5 should result in 0.5, 0, 0");
	STAssertEquals([redDarkened greenComponent], [red greenComponent],
				   @"Darkening and saturating red by 0.5 should not change its green");
	STAssertEquals([redDarkened blueComponent], [red blueComponent],
				   @"Darkening and saturating red by 0.5 should not change its blue");
}
- (void)testDarkenAndSaturatePink
{
	...
	STAssertEquals([pinkDarkened redComponent], (CGFloat)0.5f,
				   @"Darkening and saturating pink by 0.5 should result in 0.5, 0.25, 0.25");
	STAssertEquals([pinkDarkened greenComponent], (CGFloat)0.25f,
				   @"Darkening and saturating pink by 0.5 should result in 0.5, 0.25, 0.25");
	STAssertEquals([pinkDarkened blueComponent], (CGFloat)0.25f,
				   @"Darkening and saturating pink by 0.5 should result in 0.5, 0.25, 0.25");
}
...
- (void)testInvertLuminanceOfWhite
{
	...
	STAssertEquals([black redComponent], (CGFloat)1.0f - [white whiteComponent],
				   @"White, luminance-inverted, should be black (red component should be %f",
				   (CGFloat)1.0f - [white whiteComponent]);
	STAssertEquals([black greenComponent], (CGFloat)1.0f - [white whiteComponent],
				   @"White, luminance-inverted, should be black (green component should be %f",
				   (CGFloat)1.0f - [white whiteComponent]);
	STAssertEquals([black blueComponent], (CGFloat)1.0f - [white whiteComponent],
				   @"White, luminance-inverted, should be black (blue component should be %f",
				   (CGFloat)1.0f - [white whiteComponent]);
}
- (void)testInvertLuminanceOfBlack
{
	...
	STAssertEquals([white redComponent], (CGFloat)1.0f - [black whiteComponent],
				   @"Black, luminance-inverted, should be white (red component should be %f",
				   (CGFloat)1.0f - [white whiteComponent]);
	STAssertEquals([white greenComponent], (CGFloat)1.0f - [black whiteComponent],
				   @"Black, luminance-inverted, should be white (green component should be %f",
				   (CGFloat)1.0f - [white whiteComponent]);
	STAssertEquals([white blueComponent], (CGFloat)1.0f - [black whiteComponent],
				   @"Black, luminance-inverted, should be white (blue component should be %f",
				   (CGFloat)1.0f - [white whiteComponent]);
}
...
- (void)testContrastingColorForWhite
{
	...
	// contrastingColor inverts the R, G, and B components if the receiver is not medium, so its result will be in an
	// RGB color space. This is why we compare its RGB components rather than its white component (it has no white
	// component).
	STAssertEquals([contrastingColor redComponent], (CGFloat)0.0f,
				   @"White's contrasting color should be black (its red component should be 0)");
	STAssertEquals([contrastingColor greenComponent], (CGFloat)0.0f,
				   @"White's contrasting color should be black (its green component should be 0)");
	STAssertEquals([contrastingColor blueComponent], (CGFloat)0.0f,
				   @"White's contrasting color should be black (its blue component should be 0)");
}
- (void)testContrastingColorForBlack
{
	...
	// RGB color space. This is why we compare its RGB components rather than its white component (it has no white
	// component).
	STAssertEquals([contrastingColor redComponent], (CGFloat)1.0f,
				   @"Black's contrasting color should be white (its red component should be 1)");
	STAssertEquals([contrastingColor greenComponent], (CGFloat)1.0f,
				   @"Black's contrasting color should be white (its green component should be 1)");
	STAssertEquals([contrastingColor blueComponent], (CGFloat)1.0f,
				   @"Black's contrasting color should be white (its blue component should be 1)");
}
...
- (void)testStringRepresentationForRed
{
	...
	STAssertEqualObjects([color stringRepresentation], correctString, @"String representation for red should be %@",
						 correctString);
}
- (void)testStringRepresentationForYellow
{
	...
	STAssertEqualObjects([color stringRepresentation], correctString, @"String representation for yellow should be %@",
						 correctString);
}
- (void)testStringRepresentationForGreen
{
	...
	STAssertEqualObjects([color stringRepresentation], correctString, @"String representation for green should be %@",
						 correctString);
}
- (void)testStringRepresentationForCyan
{
	...
	STAssertEqualObjects([color stringRepresentation], correctString, @"String representation for cyan should be %@",
						 correctString);
}
- (void)testStringRepresentationForBlue
{
	...
	STAssertEqualObjects([color stringRepresentation], correctString, @"String representation for blue should be %@",
						 correctString);
}
- (void)testStringRepresentationForMagenta
{
	...
	STAssertEqualObjects([color stringRepresentation], correctString, @"String representation for magenta should be %@",
						 correctString);
}
- (void)testStringRepresentationForWhite
{
	...
	STAssertEqualObjects([color stringRepresentation], correctString, @"String representation for white should be %@",
						 correctString);
}
- (void)testStringRepresentationForBlack
{
	...
	STAssertEqualObjects([color stringRepresentation], correctString, @"String representation for black should be %@",
						 correctString);
}
...
- (void)testCSSRepresentationForRed
{
	NSColor *color = [NSColor redColor];
	NSString *correctString = @"#ff0000";
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for red (with alpha = 1) should be %@", correctString);
}
- (void)testCSSRepresentationForYellow
{
	...
	NSString *correctString = @"#ffff00";
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for yellow (with alpha = 1) should be %@", correctString);
}
- (void)testCSSRepresentationForGreen
{
	...
	NSString *correctString = @"#00ff00";
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for green (with alpha = 1) should be %@", correctString);
}
- (void)testCSSRepresentationForCyan
{
	...
	NSString *correctString = @"#00ffff";
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for cyan (with alpha = 1) should be %@", correctString);
}
- (void)testCSSRepresentationForBlue
{
	...
	NSString *correctString = @"#0000ff";
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for blue (with alpha = 1) should be %@", correctString);
}
- (void)testCSSRepresentationForMagenta
{
	...
	NSString *correctString = @"#ff00ff";
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for magenta (with alpha = 1) should be %@", correctString);
}
- (void)testCSSRepresentationForWhite
{
	...
	NSString *correctString = @"#ffffff";
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for white (with alpha = 1) should be %@", correctString);
}
- (void)testCSSRepresentationForBlack
{
	...
	NSString *correctString = @"#000000";
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for black (with alpha = 1) should be %@", correctString);
}
...
- (void)testCSSRepresentationForSemiTransparentRed
{
	...
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for red (with alpha = 0.5) should be %@", correctString);
}
- (void)testCSSRepresentationForSemiTransparentYellow
{
	...
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for yellow (with alpha = 0.5) should be %@", correctString);
}
- (void)testCSSRepresentationForSemiTransparentGreen
{
	...
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for green (with alpha = 0.5) should be %@", correctString);
}
- (void)testCSSRepresentationForSemiTransparentCyan
{
	...
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for cyan (with alpha = 0.5) should be %@", correctString);
}
- (void)testCSSRepresentationForSemiTransparentBlue
{
	...
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for blue (with alpha = 0.5) should be %@", correctString);
}
- (void)testCSSRepresentationForSemiTransparentMagenta
{
	...
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for magenta (with alpha = 0.5) should be %@", correctString);
}
- (void)testCSSRepresentationForSemiTransparentWhite
{
	...
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for white (with alpha = 0.5) should be %@", correctString);
}
- (void)testCSSRepresentationForSemiTransparentBlack
{
	...
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for black (with alpha = 0.5) should be %@", correctString);
}
...
- (void)testCSSRepresentationForTransparentRed
{
	...
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for red (with alpha = 0) should be %@", correctString);
}
- (void)testCSSRepresentationForTransparentYellow
{
	...
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for yellow (with alpha = 0) should be %@", correctString);
}
- (void)testCSSRepresentationForTransparentGreen
{
	...
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for green (with alpha = 0) should be %@", correctString);
}
- (void)testCSSRepresentationForTransparentCyan
{
	...
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for cyan (with alpha = 0) should be %@", correctString);
}
- (void)testCSSRepresentationForTransparentBlue
{
	...
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for blue (with alpha = 0) should be %@", correctString);
}
- (void)testCSSRepresentationForTransparentMagenta
{
	...
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for magenta (with alpha = 0) should be %@", correctString);
}
- (void)testCSSRepresentationForTransparentWhite
{
	...
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for white (with alpha = 0) should be %@", correctString);
}
- (void)testCSSRepresentationForTransparentBlack
{
	...
	STAssertEqualObjects([color CSSRepresentation], correctString,
						 @"CSS representation for black (with alpha = 0) should be %@", correctString);
}
...
- (void)testIntToHex_0
{
	// Cast explanation: 'x' literals are ints, whereas intToHex returns a char. STAssertEquals fails if the two objects
	// are not *exactly* the same type.
...
- (void)testRepresentedColorWithFourNonZeroComponents;
{
	...
	STAssertEquals([white greenComponent], (CGFloat)1.0f, @"Green component of white should be 1");
	STAssertEquals([white blueComponent], (CGFloat)1.0f, @"Blue component of white should be 1");
	STAssertEquals([white alphaComponent], (CGFloat)127.0f / (CGFloat)255.0f, @"Alpha component of white should be %f",
				   (CGFloat)127.0f / (CGFloat)255.0f);
}
...
- (void)testRepresentedColorWithAlphaWithThreeNonZeroComponents
{
	...
	STAssertEquals([white redComponent], (CGFloat)1.0f,
				   @"Red component of white (with alpha forced to 0.5) should be 1");
	STAssertEquals([white greenComponent], (CGFloat)1.0f,
				   @"Green component of white (with alpha forced to 0.5) should be 1");
	STAssertEquals([white blueComponent], (CGFloat)1.0f,
				   @"Blue component of white (with alpha forced to 0.5) should be 1");
	STAssertEquals([white alphaComponent], (CGFloat)0.5f,
				   @"Alpha component of white (with alpha forced to 0.5) should be 0.5");
}
- (void)testRepresentedColorWithAlphaWithThreeZeroComponents
{
	NSColor *black = [@"0,0,0" representedColorWithAlpha:0.5f];
	STAssertEquals([black redComponent], (CGFloat)0.0f,
				   @"Red component of black (with alpha forced to 0.5) should be 0");
	STAssertEquals([black greenComponent], (CGFloat)0.0f,
				   @"Green component of black (with alpha forced to 0.5) should be 0");
	STAssertEquals([black blueComponent], (CGFloat)0.0f,
				   @"Blue component of black (with alpha forced to 0.5) should be 0");
	STAssertEquals([black alphaComponent], (CGFloat)0.5f,
				   @"Alpha component of black (with alpha forced to 0.5) should be 0.5");
}
...
- (void)testRepresentedColorWithAlphaWithEmptyString
{
	...
	STAssertEquals(noColor, (NSColor *)nil,
				   @"Color represented by the empty string (with alpha forced to 0.5f) should be nil");
}
- (void)testRepresentedColorWithAlphaWithInvalidString;
{
	NSColor *noColor = [TEST_STRING_2 representedColorWithAlpha:0.5f];
	STAssertEquals(noColor, (NSColor *)nil, @"Color represented by '%@' (with alpha forced to 0.5) should be nil",
				   TEST_STRING_1);
}
- (void)testRepresentedColorWithAlphaWithTwoCommas;
{
	NSColor *noColor = [@",," representedColorWithAlpha:0.5f];
	STAssertEquals(noColor, (NSColor *)nil,
				   @"Color represented by two commas (with alpha forced to 0.5) should be nil");
}
- (void)testRepresentedColorWithAlphaWithThreeCommas;
{
	NSColor *noColor = [@",,," representedColorWithAlpha:0.5f];
	STAssertEquals(noColor, (NSColor *)nil,
				   @"Color represented by three commas (with alpha forced to 0.5) should be nil");
}
...
// These methods are automatically generated! If you want to change them, please change the program in the Utilities
// folder instead. Otherwise, your changes may be clobbered by the next person.
...
- (void)testColorWith6DigitHTMLStringForTransparentYellowLowercase
{
	...
	STAssertEquals([transparentYellow redComponent], (CGFloat)1.0f,
				   @"Red component of transparent yellow should be 1.0");
	STAssertEquals([transparentYellow greenComponent], (CGFloat)1.0f,
				   @"Green component of transparent yellow should be 1.0");
	STAssertEquals([transparentYellow blueComponent], (CGFloat)0.0f,
				   @"Blue component of transparent yellow should be 0.0");
}
...
- (void)testColorWith6DigitHTMLStringForTransparentGreenLowercase
{
	...
	STAssertEquals([transparentGreen greenComponent], (CGFloat)1.0f,
				   @"Green component of transparent green should be 1.0");
	STAssertEquals([transparentGreen blueComponent], (CGFloat)0.0f,
				   @"Blue component of transparent green should be 0.0");
}
...
- (void)testColorWith6DigitHTMLStringForTransparentCyanLowercase
{
	...
	STAssertEquals([transparentCyan greenComponent], (CGFloat)1.0f,
				   @"Green component of transparent cyan should be 1.0");
...
- (void)testColorWith6DigitHTMLStringForTransparentBlueLowercase
{
	...
	STAssertEquals([transparentBlue greenComponent], (CGFloat)0.0f,
				   @"Green component of transparent blue should be 0.0");
...
- (void)testColorWith6DigitHTMLStringForTransparentMagentaLowercase
{
	...
	STAssertEquals([transparentMagenta redComponent], (CGFloat)1.0f,
				   @"Red component of transparent magenta should be 1.0");
	STAssertEquals([transparentMagenta greenComponent], (CGFloat)0.0f,
				   @"Green component of transparent magenta should be 0.0");
	STAssertEquals([transparentMagenta blueComponent], (CGFloat)1.0f,
				   @"Blue component of transparent magenta should be 1.0");
}
...
- (void)testColorWith6DigitHTMLStringForTransparentWhiteLowercase
{
	...
	STAssertEquals([transparentWhite greenComponent], (CGFloat)1.0f,
				   @"Green component of transparent white should be 1.0");
	STAssertEquals([transparentWhite blueComponent], (CGFloat)1.0f,
				   @"Blue component of transparent white should be 1.0");
}
...
- (void)testColorWith6DigitHTMLStringForTransparentBlackLowercase
{
	...
	STAssertEquals([transparentBlack greenComponent], (CGFloat)0.0f,
				   @"Green component of transparent black should be 0.0");
	STAssertEquals([transparentBlack blueComponent], (CGFloat)0.0f,
				   @"Blue component of transparent black should be 0.0");
}
...
- (void)testColorWith8DigitHTMLStringForTransparentYellowLowercase
{
	...
	STAssertEquals([transparentYellow blueComponent], (CGFloat)0.0f,
				   @"Blue component of transparent yellow should be 0.0");
	STAssertEquals([transparentYellow alphaComponent], (CGFloat)0.0f,
				   @"Alpha component of transparent yellow should be 0.0");
}
...
- (void)testColorWith8DigitHTMLStringForTransparentGreenLowercase
{
	...
	STAssertEquals([transparentGreen blueComponent], (CGFloat)0.0f,
				   @"Blue component of transparent green should be 0.0");
	STAssertEquals([transparentGreen alphaComponent], (CGFloat)0.0f,
				   @"Alpha component of transparent green should be 0.0");
}
...
- (void)testColorWith8DigitHTMLStringForTransparentCyanLowercase
{
	...
	STAssertEquals([transparentCyan greenComponent], (CGFloat)1.0f,
				   @"Green component of transparent cyan should be 1.0");
	STAssertEquals([transparentCyan blueComponent], (CGFloat)1.0f, @"Blue component of transparent cyan should be 1.0");
	STAssertEquals([transparentCyan alphaComponent], (CGFloat)0.0f,
				   @"Alpha component of transparent cyan should be 0.0");
}
...
- (void)testColorWith8DigitHTMLStringForTransparentBlueLowercase
{
	...
	STAssertEquals([transparentBlue greenComponent], (CGFloat)0.0f,
				   @"Green component of transparent blue should be 0.0");
	STAssertEquals([transparentBlue blueComponent], (CGFloat)1.0f, @"Blue component of transparent blue should be 1.0");
	STAssertEquals([transparentBlue alphaComponent], (CGFloat)0.0f,
				   @"Alpha component of transparent blue should be 0.0");
}
...
- (void)testColorWith8DigitHTMLStringForTransparentMagentaLowercase
{
	...
	STAssertEquals([transparentMagenta blueComponent], (CGFloat)1.0f,
				   @"Blue component of transparent magenta should be 1.0");
	STAssertEquals([transparentMagenta alphaComponent], (CGFloat)0.0f,
				   @"Alpha component of transparent magenta should be 0.0");
}
...
- (void)testColorWith8DigitHTMLStringForTransparentWhiteLowercase
{
	...
	STAssertEquals([transparentWhite blueComponent], (CGFloat)1.0f,
				   @"Blue component of transparent white should be 1.0");
	STAssertEquals([transparentWhite alphaComponent], (CGFloat)0.0f,
				   @"Alpha component of transparent white should be 0.0");
}
...
- (void)testColorWith8DigitHTMLStringForTransparentBlackLowercase
{
	...
	STAssertEquals([transparentBlack blueComponent], (CGFloat)0.0f,
				   @"Blue component of transparent black should be 0.0");
	STAssertEquals([transparentBlack alphaComponent], (CGFloat)0.0f,
				   @"Alpha component of transparent black should be 0.0");
}
...
- (void)testColorWithHTMLStringWithNilWithDefaultColorRed;
{
	...
	STAssertEquals(color, red,
				   @"colorWithHTMLString:defaultColor:, when passed nil and redColor, should return redColor");
}
- (void)testColorWithHTMLStringWithNilWithDefaultColorGreen;
{
	...
	STAssertEquals(color, green,
				   @"colorWithHTMLString:defaultColor:, when passed nil and greenColor, should return greenColor");
}
- (void)testColorWithHTMLStringWithNilWithDefaultColorNil;
{
	NSColor *color = [NSColor colorWithHTMLString:nil defaultColor:nil];
	STAssertEquals(color, (NSColor *)nil,
				   @"colorWithHTMLString:defaultColor:, when passed nil (string) and nil (default color), should "
...
- (void)testColorWithHTMLStringWithEmptyStringWithDefaultColorRed
{
	...
	STAssertEquals(
		color, red,
		@"colorWithHTMLString:defaultColor:, when passed the empty string and redColor, should return redColor");
}
- (void)testColorWithHTMLStringWithEmptyStringWithDefaultColorGreen;
{
	...
	STAssertEquals(
		color, green,
		@"colorWithHTMLString:defaultColor:, when passed the empty string and greenColor, should return greenColor");
}
- (void)testColorWithHTMLStringWithEmptyStringWithDefaultColorNil;
{
	NSColor *color = [NSColor colorWithHTMLString:@"" defaultColor:nil];
	STAssertEquals(color, (NSColor *)nil,
				   @"colorWithHTMLString:defaultColor:, when passed the empty string and nil, should return nil");
}
...
- (void)testColorWithHTMLStringWithInvalidColorWithDefaultColorRed
{
	...
	STAssertEquals(
		color, red,
		@"colorWithHTMLString:defaultColor:, when passed an invalid string and redColor, should return redColor");
}
- (void)testColorWithHTMLStringWithInvalidColorWithDefaultColorGreen
{
	...
	STAssertEquals(
		color, green,
		@"colorWithHTMLString:defaultColor:, when passed an invalid string and greenColor, should return greenColor");
}
- (void)testColorWithHTMLStringWithInvalidColorWithDefaultColorNil
{
	...
	STAssertEquals(
		color, blue,
		@"colorWithHTMLString:defaultColor:, when passed an invalid string and blueColor, should return blueColor");
}

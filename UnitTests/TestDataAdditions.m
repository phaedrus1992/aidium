...
- (void)testSubdataFromIndex
{
	...
	// Cast explanation: Character literals are of type int. STAssertEquals also checks that the two sides are of the
	// same type, and const char is not int, so the assertion fails unless we cast the literals to const char.

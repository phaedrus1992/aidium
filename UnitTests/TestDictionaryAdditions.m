...
{
	return [NSMutableDictionary dictionaryWithObjectsAndKeys:[NSNumber numberWithUnsignedInteger:0U], @"Foo",
															 [NSNumber numberWithUnsignedInteger:1U], @"Bar",
															 [NSNumber numberWithUnsignedInteger:2U], @"Baz", nil];
}
- (NSDictionary *)translation
{
	return [NSDictionary dictionaryWithObjectsAndKeys:@"Green", @"Foo", @"Red", @"Bar", @"Blue", @"Baz", nil];
}
- (NSDictionary *)addition
{
	return [NSDictionary dictionaryWithObjectsAndKeys:[NSNumber numberWithUnsignedInteger:3U], @"Qux",
													  [NSNumber numberWithUnsignedInteger:4U], @"Quux",
													  [NSNumber numberWithUnsignedInteger:5U], @"Quuux", nil];
}
- (NSSet *)deletia
{
...
- (void)testTranslateAddRemove_translate
{
	...
	[dict translate:translation add:nil remove:nil];

	STAssertNotNil([dict objectForKey:[translation objectForKey:@"Foo"]],
				   @"translate:add:remove: method failed to translate %@ to %@", @"Foo",
				   [translation objectForKey:@"Foo"]);
	STAssertNotNil([dict objectForKey:[translation objectForKey:@"Bar"]],
				   @"translate:add:remove: method failed to translate %@ to %@", @"Bar",
				   [translation objectForKey:@"Bar"]);
	STAssertNotNil([dict objectForKey:[translation objectForKey:@"Baz"]],
				   @"translate:add:remove: method failed to translate %@ to %@", @"Baz",
				   [translation objectForKey:@"Baz"]);
}
...
- (void)testTranslateAddRemove_add
{
	...
	[dict translate:nil add:[self addition] remove:nil];
...
- (void)testTranslateAddRemove_remove
{
	...
	[dict translate:nil add:nil remove:[self deletia]];
...
- (void)testTranslateAddRemove_translateAdd
{
	...
	[dict translate:translation add:[self addition] remove:nil];
...
- (void)testTranslateAddRemove_translateRemove
{
	...
	[dict translate:translation add:nil remove:[self deletia]];
...
- (void)testTranslateAddRemove_addRemove
{
	...
	[dict translate:nil add:[self addition] remove:[self deletia]];
...
- (void)testTranslateAddRemove_translateAddRemove
{
	...
	[dict translate:translation add:[self addition] remove:[self deletia]];

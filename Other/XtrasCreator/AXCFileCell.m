...
- (void)drawInteriorWithFrame:(NSRect)cellFrame inView:(NSView *)view
{
	...
	/*draw the icon*/ {
		...
		NSRect imageSrcRect = {NSZeroPoint, imageSize};
	...
	/*draw the filename*/ {
		...
		NSRect destRect = {{cellFrame.origin.x + leftMargin, cellFrame.origin.y + gutter},
		...
		NSDictionary *attrs =
			[NSDictionary dictionaryWithObjectsAndKeys:[NSFont systemFontOfSize:0.0], NSFontAttributeName, textColor,

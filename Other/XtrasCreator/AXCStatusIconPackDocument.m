...
{
	return [NSArray arrayWithObjects:@"List", @"Tabs", nil];
}

- (NSArray *)entriesForNewDocumentInCategory:(NSString *)categoryName
{
	return [NSArray arrayWithObjects:[AXCIconPackEntry entryWithKey:@"Generic Available" path:nil],
									 ...
									 [AXCIconPackEntry entryWithKey:@"typing" path:nil], nil];
}
